  ...
  <nav class="navbar navbar-inverse" >
    ...
    <div class="body" style="margin: 40px">
        ...
        <th>Delete</th>
 			...
 			<?php
				$sql="select s.*,o.image,o.name,o.quantity,o.colour,o.size,o.buyer_email from submitted_offers s inner join offers o on s.offer_id=o.o_id where s.g_email='$email'";
            ...
            <td>'.$row['status'].'</td>
            <td>
                <button class="btn btn-danger"  onclick="window.location.href=\'./delete.php?s_id='.$row['id'].'\'">Delete</button>
                </td>
		 			</tr> ';
				}
			?>
